 ...
 164                     ; 95 }
 167  0098 81            	ret
 277                     ; 105 void TIM1_TimeBaseInit(uint16_t TIM1_Prescaler,
 277                     ; 106                        TIM1_CounterMode_TypeDef TIM1_CounterMode,
 277                     ; 107                        uint16_t TIM1_Period,
 277                     ; 108                        uint8_t TIM1_RepetitionCounter)
 277                     ; 109 {
 278                     	switch	.text
 279  0099               _TIM1_TimeBaseInit:
 281  0099 89            	pushw	x
 282       00000000      OFST:	set	0
 285                     ; 112     assert_param(IS_TIM1_COUNTER_MODE_OK(TIM1_CounterMode));
 ...
 313  00c9               L41:
 314                     ; 115     TIM1->ARRH = (uint8_t)(TIM1_Period >> 8);
 316  00c9 7b06          	ld	a,(OFST+6,sp)
 317  00cb c75262        	ld	21090,a
 318                     ; 116     TIM1->ARRL = (uint8_t)(TIM1_Period);
 320  00ce 7b07          	ld	a,(OFST+7,sp)
 321  00d0 c75263        	ld	21091,a
 322                     ; 119     TIM1->PSCRH = (uint8_t)(TIM1_Prescaler >> 8);
 324  00d3 7b01          	ld	a,(OFST+1,sp)
 325  00d5 c75260        	ld	21088,a
 326                     ; 120     TIM1->PSCRL = (uint8_t)(TIM1_Prescaler);
 328  00d8 7b02          	ld	a,(OFST+2,sp)
 329  00da c75261        	ld	21089,a
 330                     ; 123     TIM1->CR1 = (uint8_t)((uint8_t)(TIM1->CR1 & (uint8_t)(~(TIM1_CR1_CMS | TIM1_CR1_DIR)))
 330                     ; 124                            | (uint8_t)(TIM1_CounterMode));
 332  00dd c65250        	ld	a,21072
 333  00e0 a48f          	and	a,#143
 334  00e2 1a05          	or	a,(OFST+5,sp)
 335  00e4 c75250        	ld	21072,a
 336                     ; 127     TIM1->RCR = TIM1_RepetitionCounter;
 338  00e7 7b08          	ld	a,(OFST+8,sp)
 339  00e9 c75264        	ld	21092,a
 340                     ; 129 }
 343  00ec 85            	popw	x
 344  00ed 81            	ret
 630                     ; 150 void TIM1_OC1Init(TIM1_OCMode_TypeDef TIM1_OCMode,
 630                     ; 151                   TIM1_OutputState_TypeDef TIM1_OutputState,
 630                     ; 152                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
 630                     ; 153                   uint16_t TIM1_Pulse,
 630                     ; 154                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
 630                     ; 155                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
 630                     ; 156                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
 630                     ; 157                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
 630                     ; 158 {
 631                     	switch	.text
 ...
 639                     ; 160     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
 641  00f1 9e            	ld	a,xh
 642  00f2 4d            	tnz	a
 ...
 671  0121               L42:
 672                     ; 161     assert_param(IS_TIM1_OUTPUT_STATE_OK(TIM1_OutputState));
 ...
 691  013e               L23:
 692                     ; 162     assert_param(IS_TIM1_OUTPUTN_STATE_OK(TIM1_OutputNState));
 ...
 711  015b               L04:
 712                     ; 163     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
 ...
 731  0178               L64:
 732                     ; 164     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
 ...
 751  0195               L45:
 752                     ; 165     assert_param(IS_TIM1_OCIDLE_STATE_OK(TIM1_OCIdleState));
 ...
 771  01b2               L26:
 772                     ; 166     assert_param(IS_TIM1_OCNIDLE_STATE_OK(TIM1_OCNIdleState));
 ...
 791  01cf               L07:
 792                     ; 170     TIM1->CCER1 &= (uint8_t)(~( TIM1_CCER1_CC1E | TIM1_CCER1_CC1NE 
 792                     ; 171                                | TIM1_CCER1_CC1P | TIM1_CCER1_CC1NP));
 794  01cf c6525c        	ld	a,21084
 795  01d2 a4f0          	and	a,#240
 796  01d4 c7525c        	ld	21084,a
 797                     ; 174   TIM1->CCER1 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER1_CC1E)
 797                     ; 175                                      | (uint8_t)(TIM1_OutputNState & TIM1_CCER1_CC1NE))
 797                     ; 176                            | (uint8_t)( (uint8_t)(TIM1_OCPolarity  & TIM1_CCER1_CC1P)
 797                     ; 177                                         | (uint8_t)(TIM1_OCNPolarity & TIM1_CCER1_CC1NP)));
 ...
 815                     ; 180     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM)) | 
 815                     ; 181                             (uint8_t)TIM1_OCMode);
 817  01f9 c65258        	ld	a,21080
 818  01fc a48f          	and	a,#143
 819  01fe 1a04          	or	a,(OFST+1,sp)
 820  0200 c75258        	ld	21080,a
 821                     ; 184     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS1 | TIM1_OISR_OIS1N));
 823  0203 c6526f        	ld	a,21103
 824  0206 a4fc          	and	a,#252
 825  0208 c7526f        	ld	21103,a
 826                     ; 186     TIM1->OISR |= (uint8_t)((uint8_t)( TIM1_OCIdleState & TIM1_OISR_OIS1 ) | 
 826                     ; 187                             (uint8_t)( TIM1_OCNIdleState & TIM1_OISR_OIS1N ));
 ...
 836                     ; 190     TIM1->CCR1H = (uint8_t)(TIM1_Pulse >> 8);
 838  021d 7b09          	ld	a,(OFST+6,sp)
 839  021f c75265        	ld	21093,a
 840                     ; 191     TIM1->CCR1L = (uint8_t)(TIM1_Pulse);
 842  0222 7b0a          	ld	a,(OFST+7,sp)
 843  0224 c75266        	ld	21094,a
 844                     ; 192 }
 847  0227 5b05          	addw	sp,#5
 848  0229 81            	ret
 953                     ; 213 void TIM1_OC2Init(TIM1_OCMode_TypeDef TIM1_OCMode,
 953                     ; 214                   TIM1_OutputState_TypeDef TIM1_OutputState,
 953                     ; 215                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
 953                     ; 216                   uint16_t TIM1_Pulse,
 953                     ; 217                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
 953                     ; 218                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
 953                     ; 219                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
 953                     ; 220                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
 953                     ; 221 {
 954                     	switch	.text
 ...
 962                     ; 223     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
 964  022d 9e            	ld	a,xh
 965  022e 4d            	tnz	a
 ...
 994  025d               L001:
 995                     ; 224     assert_param(IS_TIM1_OUTPUT_STATE_OK(TIM1_OutputState));
...
1014  027a               L601:
1015                     ; 225     assert_param(IS_TIM1_OUTPUTN_STATE_OK(TIM1_OutputNState));
...
1034  0297               L411:
1035                     ; 226     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
...
1054  02b4               L221:
1055                     ; 227     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
...
1074  02d1               L031:
1075                     ; 228     assert_param(IS_TIM1_OCIDLE_STATE_OK(TIM1_OCIdleState));
...
1094  02ee               L631:
1095                     ; 229     assert_param(IS_TIM1_OCNIDLE_STATE_OK(TIM1_OCNIdleState));
...
1114  030b               L441:
1115                     ; 233     TIM1->CCER1 &= (uint8_t)(~( TIM1_CCER1_CC2E | TIM1_CCER1_CC2NE | 
1115                     ; 234                                 TIM1_CCER1_CC2P | TIM1_CCER1_CC2NP));
1117  030b c6525c        	ld	a,21084
1118  030e a40f          	and	a,#15
1119  0310 c7525c        	ld	21084,a
1120                     ; 238     TIM1->CCER1 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER1_CC2E  ) | 
1120                     ; 239                              (uint8_t)(TIM1_OutputNState & TIM1_CCER1_CC2NE )) | 
1120                     ; 240                              (uint8_t)((uint8_t)(TIM1_OCPolarity  & TIM1_CCER1_CC2P  ) | 
1120                     ; 241                              (uint8_t)(TIM1_OCNPolarity & TIM1_CCER1_CC2NP )));
...
1138                     ; 244     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM)) | 
1138                     ; 245                              (uint8_t)TIM1_OCMode);
1140  0335 c65259        	ld	a,21081
1141  0338 a48f          	and	a,#143
1142  033a 1a04          	or	a,(OFST+1,sp)
1143  033c c75259        	ld	21081,a
1144                     ; 248     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS2 | TIM1_OISR_OIS2N));
1146  033f c6526f        	ld	a,21103
1147  0342 a4f3          	and	a,#243
1148  0344 c7526f        	ld	21103,a
1149                     ; 250     TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OISR_OIS2 & TIM1_OCIdleState) | 
1149                     ; 251                             (uint8_t)(TIM1_OISR_OIS2N & TIM1_OCNIdleState));
...
1159                     ; 254     TIM1->CCR2H = (uint8_t)(TIM1_Pulse >> 8);
1161  0359 7b09          	ld	a,(OFST+6,sp)
1162  035b c75267        	ld	21095,a
1163                     ; 255     TIM1->CCR2L = (uint8_t)(TIM1_Pulse);
1165  035e 7b0a          	ld	a,(OFST+7,sp)
1166  0360 c75268        	ld	21096,a
1167                     ; 257 }
1170  0363 5b05          	addw	sp,#5
1171  0365 81            	ret
1276                     ; 278 void TIM1_OC3Init(TIM1_OCMode_TypeDef TIM1_OCMode,
1276                     ; 279                   TIM1_OutputState_TypeDef TIM1_OutputState,
1276                     ; 280                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
1276                     ; 281                   uint16_t TIM1_Pulse,
1276                     ; 282                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
1276                     ; 283                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
1276                     ; 284                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
1276                     ; 285                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
1276                     ; 286 {
1277                     	switch	.text
...
1285                     ; 288     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
...
1317  0399               L451:
1318                     ; 289     assert_param(IS_TIM1_OUTPUT_STATE_OK(TIM1_OutputState));
...
1337  03b6               L261:
1338                     ; 290     assert_param(IS_TIM1_OUTPUTN_STATE_OK(TIM1_OutputNState));
...
1357  03d3               L071:
1358                     ; 291     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
...
1377  03f0               L671:
1378                     ; 292     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
...
1397  040d               L402:
1398                     ; 293     assert_param(IS_TIM1_OCIDLE_STATE_OK(TIM1_OCIdleState));
...
1417  042a               L212:
1418                     ; 294     assert_param(IS_TIM1_OCNIDLE_STATE_OK(TIM1_OCNIdleState));
...
1437  0447               L022:
1438                     ; 298     TIM1->CCER2 &= (uint8_t)(~( TIM1_CCER2_CC3E | TIM1_CCER2_CC3NE | 
1438                     ; 299                                 TIM1_CCER2_CC3P | TIM1_CCER2_CC3NP));
1440  0447 c6525d        	ld	a,21085
1441  044a a4f0          	and	a,#240
1442  044c c7525d        	ld	21085,a
1443                     ; 302     TIM1->CCER2 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState  & TIM1_CCER2_CC3E   ) |
1443                     ; 303                              (uint8_t)(TIM1_OutputNState & TIM1_CCER2_CC3NE  )) | 
1443                     ; 304                              (uint8_t)((uint8_t)(TIM1_OCPolarity   & TIM1_CCER2_CC3P   ) | 
1443                     ; 305                              (uint8_t)(TIM1_OCNPolarity  & TIM1_CCER2_CC3NP  )));
...
1482                     ; 318     TIM1->CCR3H = (uint8_t)(TIM1_Pulse >> 8);
1484  0495 7b09          	ld	a,(OFST+6,sp)
1485  0497 c75269        	ld	21097,a
1486                     ; 319     TIM1->CCR3L = (uint8_t)(TIM1_Pulse);
1488  049a 7b0a          	ld	a,(OFST+7,sp)
1489  049c c7526a        	ld	21098,a
1490                     ; 321 }
1493  049f 5b05          	addw	sp,#5
1494  04a1 81            	ret
1569                     ; 336 void TIM1_OC4Init(TIM1_OCMode_TypeDef TIM1_OCMode,
1569                     ; 337                   TIM1_OutputState_TypeDef TIM1_OutputState,
1569                     ; 338                   uint16_t TIM1_Pulse,
1569                     ; 339                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
1569                     ; 340                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState)
1569                     ; 341 {
1570                     	switch	.text
...
1578                     ; 343     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
...
1610  04d4               L032:
1611                     ; 344     assert_param(IS_TIM1_OUTPUT_STATE_OK(TIM1_OutputState));
...
1630  04f1               L632:
1631                     ; 345     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
...
1650  050e               L442:
1651                     ; 346     assert_param(IS_TIM1_OCIDLE_STATE_OK(TIM1_OCIdleState));
...
1670  052b               L252:
1671                     ; 349     TIM1->CCER2 &= (uint8_t)(~(TIM1_CCER2_CC4E | TIM1_CCER2_CC4P));
1673  052b c6525d        	ld	a,21085
1674  052e a4cf          	and	a,#207
1675  0530 c7525d        	ld	21085,a
1676                     ; 351     TIM1->CCER2 |= (uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER2_CC4E ) |  
1676                     ; 352                              (uint8_t)(TIM1_OCPolarity  & TIM1_CCER2_CC4P ));
...
1720  056d 81            	ret
1926                     ; 387 void TIM1_BDTRConfig(TIM1_OSSIState_TypeDef TIM1_OSSIState,
1926                     ; 388                      TIM1_LockLevel_TypeDef TIM1_LockLevel,
1926                     ; 389                      uint8_t TIM1_DeadTime,
1926                     ; 390                      TIM1_BreakState_TypeDef TIM1_Break,
1926                     ; 391                      TIM1_BreakPolarity_TypeDef TIM1_BreakPolarity,
1926                     ; 392                      TIM1_AutomaticOutput_TypeDef TIM1_AutomaticOutput)
1926                     ; 393 {
1927                     	switch	.text
...
1935                     ; 395     assert_param(IS_TIM1_OSSI_STATE_OK(TIM1_OSSIState));
...
1955  058c               L262:
1956                     ; 396     assert_param(IS_TIM1_LOCK_LEVEL_OK(TIM1_LockLevel));
...
1981  05b5               L072:
1982                     ; 397     assert_param(IS_TIM1_BREAK_STATE_OK(TIM1_Break));
...
2001  05d2               L672:
2002                     ; 398     assert_param(IS_TIM1_BREAK_POLARITY_OK(TIM1_BreakPolarity));
...
2021  05ef               L403:
2022                     ; 399     assert_param(IS_TIM1_AUTOMATIC_OUTPUT_STATE_OK(TIM1_AutomaticOutput));
...
2041  060c               L213:
2042                     ; 401     TIM1->DTR = (uint8_t)(TIM1_DeadTime);
2044  060c 7b06          	ld	a,(OFST+5,sp)
2045  060e c7526e        	ld	21102,a
2046                     ; 405     TIM1->BKR  =  (uint8_t)((uint8_t)(TIM1_OSSIState | (uint8_t)TIM1_LockLevel)  | 
2046                     ; 406                             (uint8_t)((uint8_t)(TIM1_Break | (uint8_t)TIM1_BreakPolarity)  | 
2046                     ; 407                             (uint8_t)TIM1_AutomaticOutput));
...
2271                     ; 431     assert_param(IS_TIM1_CHANNEL_OK(TIM1_Channel));
...
2297  064c               L223:
2298                     ; 432     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
...
2317  0669               L033:
2318                     ; 433     assert_param(IS_TIM1_IC_SELECTION_OK(TIM1_ICSelection));
...
2341  068e               L633:
2342                     ; 434     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_ICPrescaler));
...
2367  06b7               L443:
2368                     ; 435     assert_param(IS_TIM1_IC_FILTER_OK(TIM1_ICFilter));
...
2384  06d0               L053:
2385                     ; 437     if (TIM1_Channel == TIM1_CHANNEL_1)
2387  06d0 0d01          	tnz	(OFST+1,sp)
2388  06d2 2614          	jrne	L176
2389                     ; 440         TI1_Config((uint8_t)TIM1_ICPolarity,
2389                     ; 441                    (uint8_t)TIM1_ICSelection,
2389                     ; 442                    (uint8_t)TIM1_ICFilter);
...
2399  06e0 84            	pop	a
2400                     ; 444         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
2402  06e1 7b06          	ld	a,(OFST+6,sp)
2403  06e3 cd126b        	call	_TIM1_SetIC1Prescaler
2406  06e6 2046          	jra	L376
2407  06e8               L176:
2408                     ; 446     else if (TIM1_Channel == TIM1_CHANNEL_2)
2410  06e8 7b01          	ld	a,(OFST+1,sp)
2411  06ea a101          	cp	a,#1
2412  06ec 2614          	jrne	L576
2413                     ; 449         TI2_Config((uint8_t)TIM1_ICPolarity,
2413                     ; 450                    (uint8_t)TIM1_ICSelection,
2413                     ; 451                    (uint8_t)TIM1_ICFilter);
...
2423  06fa 84            	pop	a
2424                     ; 453         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
2426  06fb 7b06          	ld	a,(OFST+6,sp)
2427  06fd cd129a        	call	_TIM1_SetIC2Prescaler
2430  0700 202c          	jra	L376
2431  0702               L576:
2432                     ; 455     else if (TIM1_Channel == TIM1_CHANNEL_3)
2434  0702 7b01          	ld	a,(OFST+1,sp)
2435  0704 a102          	cp	a,#2
2436  0706 2614          	jrne	L107
2437                     ; 458         TI3_Config((uint8_t)TIM1_ICPolarity,
2437                     ; 459                    (uint8_t)TIM1_ICSelection,
2437                     ; 460                    (uint8_t)TIM1_ICFilter);
...
2447  0714 84            	pop	a
2448                     ; 462         TIM1_SetIC3Prescaler(TIM1_ICPrescaler);
2450  0715 7b06          	ld	a,(OFST+6,sp)
2451  0717 cd12c9        	call	_TIM1_SetIC3Prescaler
2454  071a 2012          	jra	L376
2455  071c               L107:
2456                     ; 467         TI4_Config((uint8_t)TIM1_ICPolarity,
2456                     ; 468                    (uint8_t)TIM1_ICSelection,
2456                     ; 469                    (uint8_t)TIM1_ICFilter);
...
2466  0728 84            	pop	a
2467                     ; 471         TIM1_SetIC4Prescaler(TIM1_ICPrescaler);
...
2476  072e 85            	popw	x
2477  072f 81            	ret
2574                     ; 490 void TIM1_PWMIConfig(TIM1_Channel_TypeDef TIM1_Channel,
2574                     ; 491                      TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
2574                     ; 492                      TIM1_ICSelection_TypeDef TIM1_ICSelection,
2574                     ; 493                      TIM1_ICPSC_TypeDef TIM1_ICPrescaler,
2574                     ; 494                      uint8_t TIM1_ICFilter)
2574                     ; 495 {
2575                     	switch	.text
...
2583                     ; 496     uint8_t icpolarity = TIM1_ICPOLARITY_RISING;
2585                     ; 497     uint8_t icselection = TIM1_ICSELECTION_DIRECTTI;
2587                     ; 500     assert_param(IS_TIM1_PWMI_CHANNEL_OK(TIM1_Channel));
...
2607  074e               L063:
2608                     ; 501     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
...
2627  076b               L663:
2628                     ; 502     assert_param(IS_TIM1_IC_SELECTION_OK(TIM1_ICSelection));
...
2651  0790               L473:
2652                     ; 503     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_ICPrescaler));
...
2725  07e7 84            	pop	a
2726                     ; 532         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
2728  07e8 7b08          	ld	a,(OFST+6,sp)
2729  07ea cd126b        	call	_TIM1_SetIC1Prescaler
2731                     ; 535         TI2_Config(icpolarity, icselection, TIM1_ICFilter);
...
2741  07f9 84            	pop	a
2742                     ; 538         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
2744  07fa 7b08          	ld	a,(OFST+6,sp)
2745  07fc cd129a        	call	_TIM1_SetIC2Prescaler
2748  07ff 2024          	jra	L567
2749  0801               L367:
2750                     ; 543         TI2_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSelection,
2750                     ; 544                    (uint8_t)TIM1_ICFilter);
...
2760  080d 84            	pop	a
2761                     ; 547         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
2763  080e 7b08          	ld	a,(OFST+6,sp)
2764  0810 cd129a        	call	_TIM1_SetIC2Prescaler
2766                     ; 550         TI1_Config(icpolarity, icselection, TIM1_ICFilter);
...
2776  081f 84            	pop	a
2777                     ; 553         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
...
2787  0827 81            	ret
2843                     ; 563 void TIM1_Cmd(FunctionalState NewState)
2843                     ; 564 {
2844                     	switch	.text
2845  0828               _TIM1_Cmd:
2847  0828 88            	push	a
2848       00000000      OFST:	set	0
2851                     ; 566     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2853  0829 4d            	tnz	a
...
2869  0843               L214:
2870                     ; 569     if (NewState != DISABLE)
2872  0843 0d01          	tnz	(OFST+1,sp)
2873  0845 2706          	jreq	L5101
2874                     ; 571         TIM1->CR1 |= TIM1_CR1_CEN;
2876  0847 72105250      	bset	21072,#0
2878  084b 2004          	jra	L7101
2879  084d               L5101:
2880                     ; 575         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_CEN);
2882  084d 72115250      	bres	21072,#0
2883  0851               L7101:
2884                     ; 577 }
2887  0851 84            	pop	a
2888  0852 81            	ret
2925                     ; 585 void TIM1_CtrlPWMOutputs(FunctionalState NewState)
2925                     ; 586 {
2926                     	switch	.text
2927  0853               _TIM1_CtrlPWMOutputs:
2929  0853 88            	push	a
2930       00000000      OFST:	set	0
2933                     ; 588     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2935  0854 4d            	tnz	a
...
2951  086e               L224:
2952                     ; 592     if (NewState != DISABLE)
2954  086e 0d01          	tnz	(OFST+1,sp)
2955  0870 2706          	jreq	L7301
2956                     ; 594         TIM1->BKR |= TIM1_BKR_MOE;
2958  0872 721e526d      	bset	21101,#7
2960  0876 2004          	jra	L1401
2961  0878               L7301:
2962                     ; 598         TIM1->BKR &= (uint8_t)(~TIM1_BKR_MOE);
2964  0878 721f526d      	bres	21101,#7
2965  087c               L1401:
2966                     ; 600 }
2969  087c 84            	pop	a
2970  087d 81            	ret
3078                     ; 619 void TIM1_ITConfig(TIM1_IT_TypeDef  TIM1_IT, FunctionalState NewState)
3078                     ; 620 {
3079                     	switch	.text
3080  087e               _TIM1_ITConfig:
3082  087e 89            	pushw	x
3083       00000000      OFST:	set	0
3086                     ; 622     assert_param(IS_TIM1_IT_OK(TIM1_IT));
...
3102  0896               L034:
3103                     ; 623     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
3145  08ca 85            	popw	x
3146  08cb 81            	ret
3170                     ; 642 void TIM1_InternalClockConfig(void)
3170                     ; 643 {
3171                     	switch	.text
3172  08cc               _TIM1_InternalClockConfig:
3176                     ; 645     TIM1->SMCR &= (uint8_t)(~TIM1_SMCR_SMS);
3178  08cc c65252        	ld	a,21074
3179  08cf a4f8          	and	a,#248
3180  08d1 c75252        	ld	21074,a
3181                     ; 646 }
3184  08d4 81            	ret
3302                     ; 664 void TIM1_ETRClockMode1Config(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
3302                     ; 665                               TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
3302                     ; 666                               uint8_t ExtTRGFilter)
3302                     ; 667 {
3303                     	switch	.text
3304  08d5               _TIM1_ETRClockMode1Config:
3306  08d5 89            	pushw	x
3307       00000000      OFST:	set	0
3310                     ; 669     assert_param(IS_TIM1_EXT_PRESCALER_OK(TIM1_ExtTRGPrescaler));
...
3336  08fc               L054:
3337                     ; 670     assert_param(IS_TIM1_EXT_POLARITY_OK(TIM1_ExtTRGPolarity));
...
3356  0919               L654:
3357                     ; 673     TIM1_ETRConfig(TIM1_ExtTRGPrescaler, TIM1_ExtTRGPolarity, ExtTRGFilter);
...
3367  0924 84            	pop	a
3368                     ; 676     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~(uint8_t)(TIM1_SMCR_SMS | TIM1_SMCR_TS )))
3368                     ; 677                            | (uint8_t)((uint8_t)TIM1_SLAVEMODE_EXTERNAL1 | TIM1_TS_ETRF ));
...
3377  092f 85            	popw	x
3378  0930 81            	ret
3437                     ; 696 void TIM1_ETRClockMode2Config(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
3437                     ; 697                               TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
3437                     ; 698                               uint8_t ExtTRGFilter)
3437                     ; 699 {
3438                     	switch	.text
3439  0931               _TIM1_ETRClockMode2Config:
3441  0931 89            	pushw	x
3442       00000000      OFST:	set	0
3445                     ; 701     assert_param(IS_TIM1_EXT_PRESCALER_OK(TIM1_ExtTRGPrescaler));
...
3471  0958               L664:
3472                     ; 702     assert_param(IS_TIM1_EXT_POLARITY_OK(TIM1_ExtTRGPolarity));
...
3491  0975               L474:
3492                     ; 705     TIM1_ETRConfig(TIM1_ExtTRGPrescaler, TIM1_ExtTRGPolarity, ExtTRGFilter);
...
3502  0980 84            	pop	a
3503                     ; 708     TIM1->ETR |= TIM1_ETR_ECE;
3505  0981 721c5253      	bset	21075,#6
3506                     ; 709 }
3509  0985 85            	popw	x
3510  0986 81            	ret
3567                     ; 727 void TIM1_ETRConfig(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
3567                     ; 728                     TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
3567                     ; 729                     uint8_t ExtTRGFilter)
3567                     ; 730 {
3568                     	switch	.text
3569  0987               _TIM1_ETRConfig:
3571  0987 89            	pushw	x
3572       00000000      OFST:	set	0
3575                     ; 732     assert_param(IS_TIM1_EXT_TRG_FILTER_OK(ExtTRGFilter));
...
3591  09a1               L205:
3592                     ; 734     TIM1->ETR |= (uint8_t)((uint8_t)(TIM1_ExtTRGPrescaler | (uint8_t)TIM1_ExtTRGPolarity )|
3592                     ; 735                       (uint8_t)ExtTRGFilter );
...
3602  09ad 85            	popw	x
3603  09ae 81            	ret
3693                     ; 753 void TIM1_TIxExternalClockConfig(TIM1_TIxExternalCLK1Source_TypeDef TIM1_TIxExternalCLKSource,
3693                     ; 754                                  TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
3693                     ; 755                                  uint8_t ICFilter)
3693                     ; 756 {
3694                     	switch	.text
3695  09af               _TIM1_TIxExternalClockConfig:
3697  09af 89            	pushw	x
3698       00000000      OFST:	set	0
3701                     ; 758     assert_param(IS_TIM1_TIXCLK_SOURCE_OK(TIM1_TIxExternalCLKSource));
...
3724  09d2               L215:
3725                     ; 759     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
...
3744  09ef               L025:
3745                     ; 760     assert_param(IS_TIM1_IC_FILTER_OK(ICFilter));
...
3761  0a08               L425:
3762                     ; 763     if (TIM1_TIxExternalCLKSource == TIM1_TIXEXTERNALCLK1SOURCE_TI2)
3764  0a08 7b01          	ld	a,(OFST+1,sp)
3765  0a0a a160          	cp	a,#96
3766  0a0c 260f          	jrne	L3131
3767                     ; 765         TI2_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSELECTION_DIRECTTI, (uint8_t)ICFilter);
...
3779  0a1d               L3131:
3780                     ; 769         TI1_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSELECTION_DIRECTTI, (uint8_t)ICFilter);
...
3789  0a29 84            	pop	a
3790  0a2a               L5131:
3791                     ; 773     TIM1_SelectInputTrigger((TIM1_TS_TypeDef)TIM1_TIxExternalCLKSource);
3793  0a2a 7b01          	ld	a,(OFST+1,sp)
3794  0a2c ad0a          	call	_TIM1_SelectInputTrigger
3796                     ; 776     TIM1->SMCR |= (uint8_t)(TIM1_SLAVEMODE_EXTERNAL1);
...
3804  0a36 85            	popw	x
3805  0a37 81            	ret
3891                     ; 789 void TIM1_SelectInputTrigger(TIM1_TS_TypeDef TIM1_InputTriggerSource)
3891                     ; 790 {
3892                     	switch	.text
3893  0a38               _TIM1_SelectInputTrigger:
3895  0a38 88            	push	a
3896       00000000      OFST:	set	0
3899                     ; 792     assert_param(IS_TIM1_TRIGGER_SELECTION_OK(TIM1_InputTriggerSource));
...
3925  0a63               L435:
3926                     ; 795     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~TIM1_SMCR_TS)) | (uint8_t)TIM1_InputTriggerSource);
...
3935  0a6d 84            	pop	a
3936  0a6e 81            	ret
3973                     ; 806 void TIM1_UpdateDisableConfig(FunctionalState NewState)
3973                     ; 807 {
3974                     	switch	.text
3975  0a6f               _TIM1_UpdateDisableConfig:
3977  0a6f 88            	push	a
3978       00000000      OFST:	set	0
3981                     ; 809     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
3983  0a70 4d            	tnz	a
...
3999  0a8a               L445:
4000                     ; 812     if (NewState != DISABLE)
4002  0a8a 0d01          	tnz	(OFST+1,sp)
4003  0a8c 2706          	jreq	L3731
4004                     ; 814         TIM1->CR1 |= TIM1_CR1_UDIS;
4006  0a8e 72125250      	bset	21072,#1
4008  0a92 2004          	jra	L5731
4009  0a94               L3731:
4010                     ; 818         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_UDIS);
4012  0a94 72135250      	bres	21072,#1
4013  0a98               L5731:
4014                     ; 820 }
4017  0a98 84            	pop	a
4018  0a99 81            	ret
4077                     ; 830 void TIM1_UpdateRequestConfig(TIM1_UpdateSource_TypeDef TIM1_UpdateSource)
4077                     ; 831 {
4078                     	switch	.text
4079  0a9a               _TIM1_UpdateRequestConfig:
4081  0a9a 88            	push	a
4082       00000000      OFST:	set	0
4085                     ; 833     assert_param(IS_TIM1_UPDATE_SOURCE_OK(TIM1_UpdateSource));
4087  0a9b 4d            	tnz	a
...
4103  0ab5               L455:
4104                     ; 836     if (TIM1_UpdateSource != TIM1_UPDATESOURCE_GLOBAL)
4106  0ab5 0d01          	tnz	(OFST+1,sp)
4107  0ab7 2706          	jreq	L5241
4108                     ; 838         TIM1->CR1 |= TIM1_CR1_URS;
4110  0ab9 72145250      	bset	21072,#2
4112  0abd 2004          	jra	L7241
4113  0abf               L5241:
4114                     ; 842         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_URS);
4116  0abf 72155250      	bres	21072,#2
4117  0ac3               L7241:
4118                     ; 844 }
4121  0ac3 84            	pop	a
4122  0ac4 81            	ret
4159                     ; 853 void TIM1_SelectHallSensor(FunctionalState NewState)
4159                     ; 854 {
4160                     	switch	.text
4161  0ac5               _TIM1_SelectHallSensor:
4163  0ac5 88            	push	a
4164       00000000      OFST:	set	0
4167                     ; 856     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4169  0ac6 4d            	tnz	a
...
4185  0ae0               L465:
4186                     ; 859     if (NewState != DISABLE)
4188  0ae0 0d01          	tnz	(OFST+1,sp)
4189  0ae2 2706          	jreq	L7441
4190                     ; 861         TIM1->CR2 |= TIM1_CR2_TI1S;
4192  0ae4 721e5251      	bset	21073,#7
4194  0ae8 2004          	jra	L1541
4195  0aea               L7441:
4196                     ; 865         TIM1->CR2 &= (uint8_t)(~TIM1_CR2_TI1S);
4198  0aea 721f5251      	bres	21073,#7
4199  0aee               L1541:
4200                     ; 867 }
4203  0aee 84            	pop	a
4204  0aef 81            	ret
4262                     ; 878 void TIM1_SelectOnePulseMode(TIM1_OPMode_TypeDef TIM1_OPMode)
4262                     ; 879 {
4263                     	switch	.text
4264  0af0               _TIM1_SelectOnePulseMode:
4266  0af0 88            	push	a
4267       00000000      OFST:	set	0
4270                     ; 881     assert_param(IS_TIM1_OPM_MODE_OK(TIM1_OPMode));
...
4288  0b0b               L475:
4289                     ; 884     if (TIM1_OPMode != TIM1_OPMODE_REPETITIVE)
4291  0b0b 0d01          	tnz	(OFST+1,sp)
4292  0b0d 2706          	jreq	L1051
4293                     ; 886         TIM1->CR1 |= TIM1_CR1_OPM;
4295  0b0f 72165250      	bset	21072,#3
4297  0b13 2004          	jra	L3051
4298  0b15               L1051:
4299                     ; 890         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_OPM);
4301  0b15 72175250      	bres	21072,#3
4302  0b19               L3051:
4303                     ; 893 }
4306  0b19 84            	pop	a
4307  0b1a 81            	ret
4406                     ; 909 void TIM1_SelectOutputTrigger(TIM1_TRGOSource_TypeDef TIM1_TRGOSource)
4406                     ; 910 {
4407                     	switch	.text
4408  0b1b               _TIM1_SelectOutputTrigger:
4410  0b1b 88            	push	a
4411       00000000      OFST:	set	0
4414                     ; 912     assert_param(IS_TIM1_TRGO_SOURCE_OK(TIM1_TRGOSource));
4416  0b1c 4d            	tnz	a
...
4442  0b4a               L406:
4443                     ; 915     TIM1->CR2 = (uint8_t)((uint8_t)(TIM1->CR2 & (uint8_t)(~TIM1_CR2_MMS)) | 
4443                     ; 916                           (uint8_t) TIM1_TRGOSource);
...
4452  0b54 84            	pop	a
4453  0b55 81            	ret
4528                     ; 929 void TIM1_SelectSlaveMode(TIM1_SlaveMode_TypeDef TIM1_SlaveMode)
4528                     ; 930 {
4529                     	switch	.text
4530  0b56               _TIM1_SelectSlaveMode:
4532  0b56 88            	push	a
4533       00000000      OFST:	set	0
4536                     ; 933     assert_param(IS_TIM1_SLAVE_MODE_OK(TIM1_SlaveMode));
...
4558  0b7a               L416:
4559                     ; 936     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~TIM1_SMCR_SMS)) |
4559                     ; 937                            (uint8_t)TIM1_SlaveMode);
...
4568  0b84 84            	pop	a
4569  0b85 81            	ret
4606                     ; 947 void TIM1_SelectMasterSlaveMode(FunctionalState NewState)
4606                     ; 948 {
4607                     	switch	.text
4608  0b86               _TIM1_SelectMasterSlaveMode:
4610  0b86 88            	push	a
4611       00000000      OFST:	set	0
4614                     ; 950     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4616  0b87 4d            	tnz	a
...
4632  0ba1               L426:
4633                     ; 953     if (NewState != DISABLE)
4635  0ba1 0d01          	tnz	(OFST+1,sp)
4636  0ba3 2706          	jreq	L5161
4637                     ; 955         TIM1->SMCR |= TIM1_SMCR_MSM;
4639  0ba5 721e5252      	bset	21074,#7
4641  0ba9 2004          	jra	L7161
4642  0bab               L5161:
4643                     ; 959         TIM1->SMCR &= (uint8_t)(~TIM1_SMCR_MSM);
4645  0bab 721f5252      	bres	21074,#7
4646  0baf               L7161:
4647                     ; 961 }
4650  0baf 84            	pop	a
4651  0bb0 81            	ret
4738                     ; 983 void TIM1_EncoderInterfaceConfig(TIM1_EncoderMode_TypeDef TIM1_EncoderMode,
4738                     ; 984                                  TIM1_ICPolarity_TypeDef TIM1_IC1Polarity,
4738                     ; 985                                  TIM1_ICPolarity_TypeDef TIM1_IC2Polarity)
4738                     ; 986 {
4739                     	switch	.text
4740  0bb1               _TIM1_EncoderInterfaceConfig:
4742  0bb1 89            	pushw	x
4743       00000000      OFST:	set	0
4746                     ; 990     assert_param(IS_TIM1_ENCODER_MODE_OK(TIM1_EncoderMode));
...
4769  0bd4               L436:
4770                     ; 991     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_IC1Polarity));
...
4789  0bf1               L246:
4790                     ; 992     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_IC2Polarity));
...
4809  0c0e               L056:
4810                     ; 995     if (TIM1_IC1Polarity != TIM1_ICPOLARITY_RISING)
4812  0c0e 0d02          	tnz	(OFST+2,sp)
4813  0c10 2706          	jreq	L1661
4814                     ; 997         TIM1->CCER1 |= TIM1_CCER1_CC1P;
4816  0c12 7212525c      	bset	21084,#1
4818  0c16 2004          	jra	L3661
4819  0c18               L1661:
4820                     ; 1001         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
4822  0c18 7213525c      	bres	21084,#1
4823  0c1c               L3661:
4824                     ; 1004     if (TIM1_IC2Polarity != TIM1_ICPOLARITY_RISING)
4826  0c1c 0d05          	tnz	(OFST+5,sp)
4827  0c1e 2706          	jreq	L5661
4828                     ; 1006         TIM1->CCER1 |= TIM1_CCER1_CC2P;
4830  0c20 721a525c      	bset	21084,#5
4832  0c24 2004          	jra	L7661
4833  0c26               L5661:
4834                     ; 1010         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
4836  0c26 721b525c      	bres	21084,#5
4837  0c2a               L7661:
4838                     ; 1013     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(TIM1_SMCR_MSM | TIM1_SMCR_TS))
4838                     ; 1014                            | (uint8_t) TIM1_EncoderMode);
4840  0c2a c65252        	ld	a,21074
4841  0c2d a4f0          	and	a,#240
4842  0c2f 1a01          	or	a,(OFST+1,sp)
4843  0c31 c75252        	ld	21074,a
4844                     ; 1017     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_CCxS)) 
4844                     ; 1018                             | (uint8_t) CCMR_TIxDirect_Set);
4846  0c34 c65258        	ld	a,21080
4847  0c37 a4fc          	and	a,#252
4848  0c39 aa01          	or	a,#1
4849  0c3b c75258        	ld	21080,a
4850                     ; 1019     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_CCxS))
4850                     ; 1020                             | (uint8_t) CCMR_TIxDirect_Set);
...
4859  0c48 85            	popw	x
4860  0c49 81            	ret
4928                     ; 1035 void TIM1_PrescalerConfig(uint16_t Prescaler,
4928                     ; 1036                           TIM1_PSCReloadMode_TypeDef TIM1_PSCReloadMode)
4928                     ; 1037 {
4929                     	switch	.text
4930  0c4a               _TIM1_PrescalerConfig:
4932  0c4a 89            	pushw	x
4933       00000000      OFST:	set	0
4936                     ; 1039     assert_param(IS_TIM1_PRESCALER_RELOAD_OK(TIM1_PSCReloadMode));
...
4955  0c68               L066:
4956                     ; 1042     TIM1->PSCRH = (uint8_t)(Prescaler >> 8);
4958  0c68 7b01          	ld	a,(OFST+1,sp)
4959  0c6a c75260        	ld	21088,a
4960                     ; 1043     TIM1->PSCRL = (uint8_t)(Prescaler);
4962  0c6d 7b02          	ld	a,(OFST+2,sp)
4963  0c6f c75261        	ld	21089,a
4964                     ; 1046     TIM1->EGR = (uint8_t)TIM1_PSCReloadMode;
4966  0c72 7b05          	ld	a,(OFST+5,sp)
4967  0c74 c75257        	ld	21079,a
4968                     ; 1048 }
4971  0c77 85            	popw	x
4972  0c78 81            	ret
5009                     ; 1061 void TIM1_CounterModeConfig(TIM1_CounterMode_TypeDef TIM1_CounterMode)
5009                     ; 1062 {
5010                     	switch	.text
5011  0c79               _TIM1_CounterModeConfig:
5013  0c79 88            	push	a
5014       00000000      OFST:	set	0
5017                     ; 1064     assert_param(IS_TIM1_COUNTER_MODE_OK(TIM1_CounterMode));
5019  0c7a 4d            	tnz	a
...
5041  0ca0               L076:
5042                     ; 1068     TIM1->CR1 = (uint8_t)((uint8_t)(TIM1->CR1 & (uint8_t)((uint8_t)(~TIM1_CR1_CMS) & (uint8_t)(~TIM1_CR1_DIR)))
5042                     ; 1069                           | (uint8_t)TIM1_CounterMode);
...
5051  0caa 84            	pop	a
5052  0cab 81            	ret
5111                     ; 1081 void TIM1_ForcedOC1Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
5111                     ; 1082 {
5112                     	switch	.text
5113  0cac               _TIM1_ForcedOC1Config:
5115  0cac 88            	push	a
5116       00000000      OFST:	set	0
5119                     ; 1084     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
...
5137  0cc8               L007:
5138                     ; 1087     TIM1->CCMR1 =  (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM))|
5138                     ; 1088                              (uint8_t)TIM1_ForcedAction);
...
5147  0cd2 84            	pop	a
5148  0cd3 81            	ret
5185                     ; 1100 void TIM1_ForcedOC2Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
5185                     ; 1101 {
5186                     	switch	.text
5187  0cd4               _TIM1_ForcedOC2Config:
5189  0cd4 88            	push	a
5190       00000000      OFST:	set	0
5193                     ; 1103     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
...
5211  0cf0               L017:
5212                     ; 1106     TIM1->CCMR2  =  (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM))
5212                     ; 1107                               | (uint8_t)TIM1_ForcedAction);
...
5221  0cfa 84            	pop	a
5222  0cfb 81            	ret
5259                     ; 1120 void TIM1_ForcedOC3Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
5259                     ; 1121 {
5260                     	switch	.text
5261  0cfc               _TIM1_ForcedOC3Config:
5263  0cfc 88            	push	a
5264       00000000      OFST:	set	0
5267                     ; 1123     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
...
5285  0d18               L027:
5286                     ; 1126     TIM1->CCMR3  =  (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM))  
5286                     ; 1127                               | (uint8_t)TIM1_ForcedAction);
...
5295  0d22 84            	pop	a
5296  0d23 81            	ret
5333                     ; 1140 void TIM1_ForcedOC4Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
5333                     ; 1141 {
5334                     	switch	.text
5335  0d24               _TIM1_ForcedOC4Config:
5337  0d24 88            	push	a
5338       00000000      OFST:	set	0
5341                     ; 1143     assert_param(IS_TIM1_FORCED_ACTION_OK(TIM1_ForcedAction));
...
5359  0d40               L037:
5360                     ; 1146     TIM1->CCMR4  =  (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) 
5360                     ; 1147                               | (uint8_t)TIM1_ForcedAction);
...
5369  0d4a 84            	pop	a
5370  0d4b 81            	ret
5407                     ; 1157 void TIM1_ARRPreloadConfig(FunctionalState NewState)
5407                     ; 1158 {
5408                     	switch	.text
5409  0d4c               _TIM1_ARRPreloadConfig:
5411  0d4c 88            	push	a
5412       00000000      OFST:	set	0
5415                     ; 1160     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5417  0d4d 4d            	tnz	a
...
5433  0d67               L047:
5434                     ; 1163     if (NewState != DISABLE)
5436  0d67 0d01          	tnz	(OFST+1,sp)
5437  0d69 2706          	jreq	L7502
5438                     ; 1165         TIM1->CR1 |= TIM1_CR1_ARPE;
5440  0d6b 721e5250      	bset	21072,#7
5442  0d6f 2004          	jra	L1602
5443  0d71               L7502:
5444                     ; 1169         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_ARPE);
5446  0d71 721f5250      	bres	21072,#7
5447  0d75               L1602:
5448                     ; 1171 }
5451  0d75 84            	pop	a
5452  0d76 81            	ret
5488                     ; 1180 void TIM1_SelectCOM(FunctionalState NewState)
5488                     ; 1181 {
5489                     	switch	.text
5490  0d77               _TIM1_SelectCOM:
5492  0d77 88            	push	a
5493       00000000      OFST:	set	0
5496                     ; 1183     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5498  0d78 4d            	tnz	a
...
5514  0d92               L057:
5515                     ; 1186     if (NewState != DISABLE)
5517  0d92 0d01          	tnz	(OFST+1,sp)
5518  0d94 2706          	jreq	L1012
5519                     ; 1188         TIM1->CR2 |= TIM1_CR2_COMS;
5521  0d96 72145251      	bset	21073,#2
5523  0d9a 2004          	jra	L3012
5524  0d9c               L1012:
5525                     ; 1192         TIM1->CR2 &= (uint8_t)(~TIM1_CR2_COMS);
5527  0d9c 72155251      	bres	21073,#2
5528  0da0               L3012:
5529                     ; 1194 }
5532  0da0 84            	pop	a
5533  0da1 81            	ret
5570                     ; 1202 void TIM1_CCPreloadControl(FunctionalState NewState)
5570                     ; 1203 {
5571                     	switch	.text
5572  0da2               _TIM1_CCPreloadControl:
5574  0da2 88            	push	a
5575       00000000      OFST:	set	0
5578                     ; 1205     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5580  0da3 4d            	tnz	a
...
5596  0dbd               L067:
5597                     ; 1208     if (NewState != DISABLE)
5599  0dbd 0d01          	tnz	(OFST+1,sp)
5600  0dbf 2706          	jreq	L3212
5601                     ; 1210         TIM1->CR2 |= TIM1_CR2_CCPC;
5603  0dc1 72105251      	bset	21073,#0
5605  0dc5 2004          	jra	L5212
5606  0dc7               L3212:
5607                     ; 1214         TIM1->CR2 &= (uint8_t)(~TIM1_CR2_CCPC);
5609  0dc7 72115251      	bres	21073,#0
5610  0dcb               L5212:
5611                     ; 1216 }
5614  0dcb 84            	pop	a
5615  0dcc 81            	ret
5652                     ; 1225 void TIM1_OC1PreloadConfig(FunctionalState NewState)
5652                     ; 1226 {
5653                     	switch	.text
5654  0dcd               _TIM1_OC1PreloadConfig:
5656  0dcd 88            	push	a
5657       00000000      OFST:	set	0
5660                     ; 1228     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5662  0dce 4d            	tnz	a
...
5678  0de8               L077:
5679                     ; 1231     if (NewState != DISABLE)
5681  0de8 0d01          	tnz	(OFST+1,sp)
5682  0dea 2706          	jreq	L5412
5683                     ; 1233         TIM1->CCMR1 |= TIM1_CCMR_OCxPE;
5685  0dec 72165258      	bset	21080,#3
5687  0df0 2004          	jra	L7412
5688  0df2               L5412:
5689                     ; 1237         TIM1->CCMR1 &= (uint8_t)(~TIM1_CCMR_OCxPE);
5691  0df2 72175258      	bres	21080,#3
5692  0df6               L7412:
5693                     ; 1239 }
5696  0df6 84            	pop	a
5697  0df7 81            	ret
5734                     ; 1248 void TIM1_OC2PreloadConfig(FunctionalState NewState)
5734                     ; 1249 {
5735                     	switch	.text
5736  0df8               _TIM1_OC2PreloadConfig:
5738  0df8 88            	push	a
5739       00000000      OFST:	set	0
5742                     ; 1251     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5744  0df9 4d            	tnz	a
...
5760  0e13               L0001:
5761                     ; 1254     if (NewState != DISABLE)
5763  0e13 0d01          	tnz	(OFST+1,sp)
5764  0e15 2706          	jreq	L7612
5765                     ; 1256         TIM1->CCMR2 |= TIM1_CCMR_OCxPE;
5767  0e17 72165259      	bset	21081,#3
5769  0e1b 2004          	jra	L1712
5770  0e1d               L7612:
5771                     ; 1260         TIM1->CCMR2 &= (uint8_t)(~TIM1_CCMR_OCxPE);
5773  0e1d 72175259      	bres	21081,#3
5774  0e21               L1712:
5775                     ; 1262 }
5778  0e21 84            	pop	a
5779  0e22 81            	ret
5816                     ; 1271 void TIM1_OC3PreloadConfig(FunctionalState NewState)
5816                     ; 1272 {
5817                     	switch	.text
5818  0e23               _TIM1_OC3PreloadConfig:
5820  0e23 88            	push	a
5821       00000000      OFST:	set	0
5824                     ; 1274     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5826  0e24 4d            	tnz	a
...
5842  0e3e               L0101:
5843                     ; 1277     if (NewState != DISABLE)
5845  0e3e 0d01          	tnz	(OFST+1,sp)
5846  0e40 2706          	jreq	L1122
5847                     ; 1279         TIM1->CCMR3 |= TIM1_CCMR_OCxPE;
5849  0e42 7216525a      	bset	21082,#3
5851  0e46 2004          	jra	L3122
5852  0e48               L1122:
5853                     ; 1283         TIM1->CCMR3 &= (uint8_t)(~TIM1_CCMR_OCxPE);
5855  0e48 7217525a      	bres	21082,#3
5856  0e4c               L3122:
5857                     ; 1285 }
5860  0e4c 84            	pop	a
5861  0e4d 81            	ret
5898                     ; 1295 void TIM1_OC4PreloadConfig(FunctionalState NewState)
5898                     ; 1296 {
5899                     	switch	.text
5900  0e4e               _TIM1_OC4PreloadConfig:
5902  0e4e 88            	push	a
5903       00000000      OFST:	set	0
5906                     ; 1298     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5908  0e4f 4d            	tnz	a
...
5924  0e69               L0201:
5925                     ; 1301     if (NewState != DISABLE)
5927  0e69 0d01          	tnz	(OFST+1,sp)
5928  0e6b 2706          	jreq	L3322
5929                     ; 1303         TIM1->CCMR4 |= TIM1_CCMR_OCxPE;
5931  0e6d 7216525b      	bset	21083,#3
5933  0e71 2004          	jra	L5322
5934  0e73               L3322:
5935                     ; 1307         TIM1->CCMR4 &= (uint8_t)(~TIM1_CCMR_OCxPE);
5937  0e73 7217525b      	bres	21083,#3
5938  0e77               L5322:
5939                     ; 1309 }
5942  0e77 84            	pop	a
5943  0e78 81            	ret
5979                     ; 1317 void TIM1_OC1FastConfig(FunctionalState NewState)
5979                     ; 1318 {
5980                     	switch	.text
5981  0e79               _TIM1_OC1FastConfig:
5983  0e79 88            	push	a
5984       00000000      OFST:	set	0
5987                     ; 1320     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
5989  0e7a 4d            	tnz	a
...
6005  0e94               L0301:
6006                     ; 1323     if (NewState != DISABLE)
6008  0e94 0d01          	tnz	(OFST+1,sp)
6009  0e96 2706          	jreq	L5522
6010                     ; 1325         TIM1->CCMR1 |= TIM1_CCMR_OCxFE;
6012  0e98 72145258      	bset	21080,#2
6014  0e9c 2004          	jra	L7522
6015  0e9e               L5522:
6016                     ; 1329         TIM1->CCMR1 &= (uint8_t)(~TIM1_CCMR_OCxFE);
6018  0e9e 72155258      	bres	21080,#2
6019  0ea2               L7522:
6020                     ; 1331 }
6023  0ea2 84            	pop	a
6024  0ea3 81            	ret
6060                     ; 1341 void TIM1_OC2FastConfig(FunctionalState NewState)
6060                     ; 1342 {
6061                     	switch	.text
6062  0ea4               _TIM1_OC2FastConfig:
6064  0ea4 88            	push	a
6065       00000000      OFST:	set	0
6068                     ; 1344     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
6070  0ea5 4d            	tnz	a
...
6086  0ebf               L0401:
6087                     ; 1347     if (NewState != DISABLE)
6089  0ebf 0d01          	tnz	(OFST+1,sp)
6090  0ec1 2706          	jreq	L7722
6091                     ; 1349         TIM1->CCMR2 |= TIM1_CCMR_OCxFE;
6093  0ec3 72145259      	bset	21081,#2
6095  0ec7 2004          	jra	L1032
6096  0ec9               L7722:
6097                     ; 1353         TIM1->CCMR2 &= (uint8_t)(~TIM1_CCMR_OCxFE);
6099  0ec9 72155259      	bres	21081,#2
6100  0ecd               L1032:
6101                     ; 1355 }
6104  0ecd 84            	pop	a
6105  0ece 81            	ret
6141                     ; 1364 void TIM1_OC3FastConfig(FunctionalState NewState)
6141                     ; 1365 {
6142                     	switch	.text
6143  0ecf               _TIM1_OC3FastConfig:
6145  0ecf 88            	push	a
6146       00000000      OFST:	set	0
6149                     ; 1367     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
6151  0ed0 4d            	tnz	a
...
6167  0eea               L0501:
6168                     ; 1370     if (NewState != DISABLE)
6170  0eea 0d01          	tnz	(OFST+1,sp)
6171  0eec 2706          	jreq	L1232
6172                     ; 1372         TIM1->CCMR3 |= TIM1_CCMR_OCxFE;
6174  0eee 7214525a      	bset	21082,#2
6176  0ef2 2004          	jra	L3232
6177  0ef4               L1232:
6178                     ; 1376         TIM1->CCMR3 &= (uint8_t)(~TIM1_CCMR_OCxFE);
6180  0ef4 7215525a      	bres	21082,#2
6181  0ef8               L3232:
6182                     ; 1378 }
6185  0ef8 84            	pop	a
6186  0ef9 81            	ret
6222                     ; 1387 void TIM1_OC4FastConfig(FunctionalState NewState)
6222                     ; 1388 {
6223                     	switch	.text
6224  0efa               _TIM1_OC4FastConfig:
6226  0efa 88            	push	a
6227       00000000      OFST:	set	0
6230                     ; 1390     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
6232  0efb 4d            	tnz	a
...
6248  0f15               L0601:
6249                     ; 1393     if (NewState != DISABLE)
6251  0f15 0d01          	tnz	(OFST+1,sp)
6252  0f17 2706          	jreq	L3432
6253                     ; 1395         TIM1->CCMR4 |= TIM1_CCMR_OCxFE;
6255  0f19 7214525b      	bset	21083,#2
6257  0f1d 2004          	jra	L5432
6258  0f1f               L3432:
6259                     ; 1399         TIM1->CCMR4 &= (uint8_t)(~TIM1_CCMR_OCxFE);
6261  0f1f 7215525b      	bres	21083,#2
6262  0f23               L5432:
6263                     ; 1401 }
6266  0f23 84            	pop	a
6267  0f24 81            	ret
6373                     ; 1418 void TIM1_GenerateEvent(TIM1_EventSource_TypeDef TIM1_EventSource)
6373                     ; 1419 {
6374                     	switch	.text
6375  0f25               _TIM1_GenerateEvent:
6377  0f25 88            	push	a
6378       00000000      OFST:	set	0
6381                     ; 1421     assert_param(IS_TIM1_EVENT_SOURCE_OK(TIM1_EventSource));
6383  0f26 4d            	tnz	a
6384  0f27 2703          	jreq	L4601
6385  0f29 4f            	clr	a
6386  0f2a 2010          	jra	L6601
6387  0f2c               L4601:
6388  0f2c ae058d        	ldw	x,#1421
...
6396  0f3c               L6601:
6397                     ; 1424     TIM1->EGR = (uint8_t)TIM1_EventSource;
6399  0f3c 7b01          	ld	a,(OFST+1,sp)
6400  0f3e c75257        	ld	21079,a
6401                     ; 1425 }
6404  0f41 84            	pop	a
6405  0f42 81            	ret
6442                     ; 1436 void TIM1_OC1PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6442                     ; 1437 {
6443                     	switch	.text
6444  0f43               _TIM1_OC1PolarityConfig:
6446  0f43 88            	push	a
6447       00000000      OFST:	set	0
6450                     ; 1439     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6452  0f44 4d            	tnz	a
...
6468  0f5e               L6701:
6469                     ; 1442     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6471  0f5e 0d01          	tnz	(OFST+1,sp)
6472  0f60 2706          	jreq	L7242
6473                     ; 1444         TIM1->CCER1 |= TIM1_CCER1_CC1P;
6475  0f62 7212525c      	bset	21084,#1
6477  0f66 2004          	jra	L1342
6478  0f68               L7242:
6479                     ; 1448         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
6481  0f68 7213525c      	bres	21084,#1
6482  0f6c               L1342:
6483                     ; 1450 }
6486  0f6c 84            	pop	a
6487  0f6d 81            	ret
6524                     ; 1461 void TIM1_OC1NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
6524                     ; 1462 {
6525                     	switch	.text
6526  0f6e               _TIM1_OC1NPolarityConfig:
6528  0f6e 88            	push	a
6529       00000000      OFST:	set	0
6532                     ; 1464     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
6534  0f6f 4d            	tnz	a
...
6550  0f89               L6011:
6551                     ; 1467     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
6553  0f89 0d01          	tnz	(OFST+1,sp)
6554  0f8b 2706          	jreq	L1542
6555                     ; 1469         TIM1->CCER1 |= TIM1_CCER1_CC1NP;
6557  0f8d 7216525c      	bset	21084,#3
6559  0f91 2004          	jra	L3542
6560  0f93               L1542:
6561                     ; 1473         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1NP);
6563  0f93 7217525c      	bres	21084,#3
6564  0f97               L3542:
6565                     ; 1475 }
6568  0f97 84            	pop	a
6569  0f98 81            	ret
6606                     ; 1486 void TIM1_OC2PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6606                     ; 1487 {
6607                     	switch	.text
6608  0f99               _TIM1_OC2PolarityConfig:
6610  0f99 88            	push	a
6611       00000000      OFST:	set	0
6614                     ; 1489     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6616  0f9a 4d            	tnz	a
...
6632  0fb4               L6111:
6633                     ; 1492     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6635  0fb4 0d01          	tnz	(OFST+1,sp)
6636  0fb6 2706          	jreq	L3742
6637                     ; 1494         TIM1->CCER1 |= TIM1_CCER1_CC2P;
6639  0fb8 721a525c      	bset	21084,#5
6641  0fbc 2004          	jra	L5742
6642  0fbe               L3742:
6643                     ; 1498         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
6645  0fbe 721b525c      	bres	21084,#5
6646  0fc2               L5742:
6647                     ; 1500 }
6650  0fc2 84            	pop	a
6651  0fc3 81            	ret
6688                     ; 1510 void TIM1_OC2NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
6688                     ; 1511 {
6689                     	switch	.text
6690  0fc4               _TIM1_OC2NPolarityConfig:
6692  0fc4 88            	push	a
6693       00000000      OFST:	set	0
6696                     ; 1513     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
6698  0fc5 4d            	tnz	a
...
6714  0fdf               L6211:
6715                     ; 1516     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
6717  0fdf 0d01          	tnz	(OFST+1,sp)
6718  0fe1 2706          	jreq	L5152
6719                     ; 1518         TIM1->CCER1 |= TIM1_CCER1_CC2NP;
6721  0fe3 721e525c      	bset	21084,#7
6723  0fe7 2004          	jra	L7152
6724  0fe9               L5152:
6725                     ; 1522         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2NP);
6727  0fe9 721f525c      	bres	21084,#7
6728  0fed               L7152:
6729                     ; 1524 }
6732  0fed 84            	pop	a
6733  0fee 81            	ret
6770                     ; 1535 void TIM1_OC3PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6770                     ; 1536 {
6771                     	switch	.text
6772  0fef               _TIM1_OC3PolarityConfig:
6774  0fef 88            	push	a
6775       00000000      OFST:	set	0
6778                     ; 1538     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6780  0ff0 4d            	tnz	a
...
6796  100a               L6311:
6797                     ; 1541     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6799  100a 0d01          	tnz	(OFST+1,sp)
6800  100c 2706          	jreq	L7352
6801                     ; 1543         TIM1->CCER2 |= TIM1_CCER2_CC3P;
6803  100e 7212525d      	bset	21085,#1
6805  1012 2004          	jra	L1452
6806  1014               L7352:
6807                     ; 1547         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3P);
6809  1014 7213525d      	bres	21085,#1
6810  1018               L1452:
6811                     ; 1549 }
6814  1018 84            	pop	a
6815  1019 81            	ret
6852                     ; 1560 void TIM1_OC3NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
6852                     ; 1561 {
6853                     	switch	.text
6854  101a               _TIM1_OC3NPolarityConfig:
6856  101a 88            	push	a
6857       00000000      OFST:	set	0
6860                     ; 1563     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
6862  101b 4d            	tnz	a
...
6878  1035               L6411:
6879                     ; 1566     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
6881  1035 0d01          	tnz	(OFST+1,sp)
6882  1037 2706          	jreq	L1652
6883                     ; 1568         TIM1->CCER2 |= TIM1_CCER2_CC3NP;
6885  1039 7216525d      	bset	21085,#3
6887  103d 2004          	jra	L3652
6888  103f               L1652:
6889                     ; 1572         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3NP);
6891  103f 7217525d      	bres	21085,#3
6892  1043               L3652:
6893                     ; 1574 }
6896  1043 84            	pop	a
6897  1044 81            	ret
6934                     ; 1584 void TIM1_OC4PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6934                     ; 1585 {
6935                     	switch	.text
6936  1045               _TIM1_OC4PolarityConfig:
6938  1045 88            	push	a
6939       00000000      OFST:	set	0
6942                     ; 1587     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6944  1046 4d            	tnz	a
...
6960  1060               L6511:
6961                     ; 1590     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6963  1060 0d01          	tnz	(OFST+1,sp)
6964  1062 2706          	jreq	L3062
6965                     ; 1592         TIM1->CCER2 |= TIM1_CCER2_CC4P;
6967  1064 721a525d      	bset	21085,#5
6969  1068 2004          	jra	L5062
6970  106a               L3062:
6971                     ; 1596         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4P);
6973  106a 721b525d      	bres	21085,#5
6974  106e               L5062:
6975                     ; 1598 }
6978  106e 84            	pop	a
6979  106f 81            	ret
7025                     ; 1613 void TIM1_CCxCmd(TIM1_Channel_TypeDef TIM1_Channel, FunctionalState NewState)
7025                     ; 1614 {
7026                     	switch	.text
7027  1070               _TIM1_CCxCmd:
7029  1070 89            	pushw	x
7030       00000000      OFST:	set	0
7033                     ; 1616     assert_param(IS_TIM1_CHANNEL_OK(TIM1_Channel));
...
7059  1097               L6611:
7060                     ; 1617     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
7234  1126               L4021:
7235                     ; 1685     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
7392  11a4               L2221:
7393                     ; 1751     assert_param(IS_TIM1_OCM_OK(TIM1_OCMode));
...
7430  11e5               L0321:
7431                     ; 1753     if (TIM1_Channel == TIM1_CHANNEL_1)
7433  11e5 0d01          	tnz	(OFST+1,sp)
7434  11e7 2610          	jrne	L5572
7435                     ; 1756         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
7437  11e9 7211525c      	bres	21084,#0
7438                     ; 1759         TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM)) 
7438                     ; 1760                                 | (uint8_t)TIM1_OCMode);
...
7446  11f9               L5572:
7447                     ; 1762     else if (TIM1_Channel == TIM1_CHANNEL_2)
7449  11f9 7b01          	ld	a,(OFST+1,sp)
7450  11fb a101          	cp	a,#1
7451  11fd 2610          	jrne	L1672
7452                     ; 1765         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2E);
7454  11ff 7219525c      	bres	21084,#4
7455                     ; 1768         TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM))
7455                     ; 1769                                 | (uint8_t)TIM1_OCMode);
...
7463  120f               L1672:
7464                     ; 1771     else if (TIM1_Channel == TIM1_CHANNEL_3)
7466  120f 7b01          	ld	a,(OFST+1,sp)
7467  1211 a102          	cp	a,#2
7468  1213 2610          	jrne	L5672
7469                     ; 1774         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3E);
7471  1215 7211525d      	bres	21085,#0
7472                     ; 1777         TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) 
7472                     ; 1778                                 | (uint8_t)TIM1_OCMode);
...
7480  1225               L5672:
7481                     ; 1783         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4E);
7483  1225 7219525d      	bres	21085,#4
7484                     ; 1786         TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) 
7484                     ; 1787                                 | (uint8_t)TIM1_OCMode);
...
7494  1233 85            	popw	x
7495  1234 81            	ret
7529                     ; 1798 void TIM1_SetCounter(uint16_t Counter)
7529                     ; 1799 {
7530                     	switch	.text
7531  1235               _TIM1_SetCounter:
7535                     ; 1801     TIM1->CNTRH = (uint8_t)(Counter >> 8);
7537  1235 9e            	ld	a,xh
7538  1236 c7525e        	ld	21086,a
7539                     ; 1802     TIM1->CNTRL = (uint8_t)(Counter);
7541  1239 9f            	ld	a,xl
7542  123a c7525f        	ld	21087,a
7543                     ; 1804 }
7546  123d 81            	ret
7580                     ; 1813 void TIM1_SetAutoreload(uint16_t Autoreload)
7580                     ; 1814 {
7581                     	switch	.text
7582  123e               _TIM1_SetAutoreload:
7586                     ; 1817     TIM1->ARRH = (uint8_t)(Autoreload >> 8);
7588  123e 9e            	ld	a,xh
7589  123f c75262        	ld	21090,a
7590                     ; 1818     TIM1->ARRL = (uint8_t)(Autoreload);
7592  1242 9f            	ld	a,xl
7593  1243 c75263        	ld	21091,a
7594                     ; 1820 }
7597  1246 81            	ret
7631                     ; 1829 void TIM1_SetCompare1(uint16_t Compare1)
7631                     ; 1830 {
7632                     	switch	.text
7633  1247               _TIM1_SetCompare1:
7637                     ; 1832     TIM1->CCR1H = (uint8_t)(Compare1 >> 8);
7639  1247 9e            	ld	a,xh
7640  1248 c75265        	ld	21093,a
7641                     ; 1833     TIM1->CCR1L = (uint8_t)(Compare1);
7643  124b 9f            	ld	a,xl
7644  124c c75266        	ld	21094,a
7645                     ; 1835 }
7648  124f 81            	ret
7682                     ; 1844 void TIM1_SetCompare2(uint16_t Compare2)
7682                     ; 1845 {
7683                     	switch	.text
7684  1250               _TIM1_SetCompare2:
7688                     ; 1847     TIM1->CCR2H = (uint8_t)(Compare2 >> 8);
7690  1250 9e            	ld	a,xh
7691  1251 c75267        	ld	21095,a
7692                     ; 1848     TIM1->CCR2L = (uint8_t)(Compare2);
7694  1254 9f            	ld	a,xl
7695  1255 c75268        	ld	21096,a
7696                     ; 1850 }
7699  1258 81            	ret
7733                     ; 1859 void TIM1_SetCompare3(uint16_t Compare3)
7733                     ; 1860 {
7734                     	switch	.text
7735  1259               _TIM1_SetCompare3:
7739                     ; 1862     TIM1->CCR3H = (uint8_t)(Compare3 >> 8);
7741  1259 9e            	ld	a,xh
7742  125a c75269        	ld	21097,a
7743                     ; 1863     TIM1->CCR3L = (uint8_t)(Compare3);
7745  125d 9f            	ld	a,xl
7746  125e c7526a        	ld	21098,a
7747                     ; 1865 }
7750  1261 81            	ret
7784                     ; 1874 void TIM1_SetCompare4(uint16_t Compare4)
7784                     ; 1875 {
7785                     	switch	.text
7786  1262               _TIM1_SetCompare4:
7790                     ; 1877     TIM1->CCR4H = (uint8_t)(Compare4 >> 8);
7792  1262 9e            	ld	a,xh
7793  1263 c7526b        	ld	21099,a
7794                     ; 1878     TIM1->CCR4L = (uint8_t)(Compare4);
7796  1266 9f            	ld	a,xl
7797  1267 c7526c        	ld	21100,a
7798                     ; 1879 }
7801  126a 81            	ret
7838                     ; 1892 void TIM1_SetIC1Prescaler(TIM1_ICPSC_TypeDef TIM1_IC1Prescaler)
7838                     ; 1893 {
7839                     	switch	.text
7840  126b               _TIM1_SetIC1Prescaler:
7842  126b 88            	push	a
7843       00000000      OFST:	set	0
7846                     ; 1895     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC1Prescaler));
7848  126c 4d            	tnz	a
...
7868  128e               L4521:
7869                     ; 1898     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_ICxPSC)) 
7869                     ; 1899                             | (uint8_t)TIM1_IC1Prescaler);
...
7878  1298 84            	pop	a
7879  1299 81            	ret
7916                     ; 1913 void TIM1_SetIC2Prescaler(TIM1_ICPSC_TypeDef TIM1_IC2Prescaler)
7916                     ; 1914 {
7917                     	switch	.text
7918  129a               _TIM1_SetIC2Prescaler:
7920  129a 88            	push	a
7921       00000000      OFST:	set	0
7924                     ; 1917     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC2Prescaler));
7926  129b 4d            	tnz	a
...
7946  12bd               L4621:
7947                     ; 1920     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_ICxPSC))
7947                     ; 1921                             | (uint8_t)TIM1_IC2Prescaler);
...
7956  12c7 84            	pop	a
7957  12c8 81            	ret
7994                     ; 1935 void TIM1_SetIC3Prescaler(TIM1_ICPSC_TypeDef TIM1_IC3Prescaler)
7994                     ; 1936 {
7995                     	switch	.text
7996  12c9               _TIM1_SetIC3Prescaler:
7998  12c9 88            	push	a
7999       00000000      OFST:	set	0
8002                     ; 1939     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC3Prescaler));
8004  12ca 4d            	tnz	a
...
8024  12ec               L4721:
8025                     ; 1942     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_ICxPSC)) | 
8025                     ; 1943                             (uint8_t)TIM1_IC3Prescaler);
...
8034  12f6 84            	pop	a
8035  12f7 81            	ret
8072                     ; 1956 void TIM1_SetIC4Prescaler(TIM1_ICPSC_TypeDef TIM1_IC4Prescaler)
8072                     ; 1957 {
8073                     	switch	.text
8074  12f8               _TIM1_SetIC4Prescaler:
8076  12f8 88            	push	a
8077       00000000      OFST:	set	0
8080                     ; 1960     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC4Prescaler));
8082  12f9 4d            	tnz	a
...
8102  131b               L4031:
8103                     ; 1963     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_ICxPSC)) |
8103                     ; 1964                             (uint8_t)TIM1_IC4Prescaler);
...
8503                     ; 2046     return (uint16_t)tmpccr4;
8505  13ba 1e03          	ldw	x,(OFST-1,sp)
8508  13bc 5b04          	addw	sp,#4
8509  13be 81            	ret
8543                     ; 2054 uint16_t TIM1_GetCounter(void)
8543                     ; 2055 {
8544                     	switch	.text
8545  13bf               _TIM1_GetCounter:
8547  13bf 89            	pushw	x
8548       00000002      OFST:	set	2
8551                     ; 2056   uint16_t tmpcntr = 0;
8553                     ; 2058   tmpcntr = ((uint16_t)TIM1->CNTRH << 8);
...
8561                     ; 2061     return (uint16_t)(tmpcntr | (uint16_t)(TIM1->CNTRL));
...
8574  13d7 81            	ret
8608                     ; 2069 uint16_t TIM1_GetPrescaler(void)
8608                     ; 2070 {
8609                     	switch	.text
8610  13d8               _TIM1_GetPrescaler:
8612  13d8 89            	pushw	x
8613       00000002      OFST:	set	2
8616                     ; 2071    uint16_t temp = 0;
8618                     ; 2073    temp = ((uint16_t)TIM1->PSCRH << 8);
...
8626                     ; 2076     return (uint16_t)( temp | (uint16_t)(TIM1->PSCRL));
...
8639  13f0 81            	ret
8814                     ; 2097 FlagStatus TIM1_GetFlagStatus(TIM1_FLAG_TypeDef TIM1_FLAG)
8814                     ; 2098 {
8815                     	switch	.text
...
8823                     ; 2099     FlagStatus bitstatus = RESET;
8825                     ; 2100     uint8_t tim1_flag_l = 0, tim1_flag_h = 0;
8829                     ; 2103     assert_param(IS_TIM1_GET_FLAG_OK(TIM1_FLAG));
...
8967  1485               L6331:
8968                     ; 2143     TIM1->SR1 = (uint8_t)(~(uint8_t)(TIM1_FLAG));
8970  1485 7b02          	ld	a,(OFST+2,sp)
8971  1487 43            	cpl	a
8972  1488 c75255        	ld	21077,a
8973                     ; 2144     TIM1->SR2 = (uint8_t)((uint8_t)(~((uint8_t)((uint16_t)TIM1_FLAG >> 8))) & 
8973                     ; 2145                           (uint8_t)0x1E);
...
8982  1493 85            	popw	x
8983  1494 81            	ret
9048                     ; 2162 ITStatus TIM1_GetITStatus(TIM1_IT_TypeDef TIM1_IT)
9048                     ; 2163 {
9049                     	switch	.text
...
9057                     ; 2164     ITStatus bitstatus = RESET;
9059                     ; 2165     uint8_t TIM1_itStatus = 0, TIM1_itEnable = 0;
9063                     ; 2168     assert_param(IS_TIM1_GET_IT_OK(TIM1_IT));
...
9188  1504               L4531:
9189                     ; 2205     TIM1->SR1 = (uint8_t)(~(uint8_t)TIM1_IT);
...
9197  150a 84            	pop	a
9198  150b 81            	ret
9250                     ; 2224 static void TI1_Config(uint8_t TIM1_ICPolarity,
9250                     ; 2225                        uint8_t TIM1_ICSelection,
9250                     ; 2226                        uint8_t TIM1_ICFilter)
9250                     ; 2227 {
9251                     	switch	.text
...
9259                     ; 2230     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
9261  150e 7211525c      	bres	21084,#0
9262                     ; 2233     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF ))) | 
9262                     ; 2234                             (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
9275                     ; 2237     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
9277  1527 0d02          	tnz	(OFST+1,sp)
9278  1529 2706          	jreq	L3163
9279                     ; 2239         TIM1->CCER1 |= TIM1_CCER1_CC1P;
9281  152b 7212525c      	bset	21084,#1
9283  152f 2004          	jra	L5163
9284  1531               L3163:
9285                     ; 2243         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
9287  1531 7213525c      	bres	21084,#1
9288  1535               L5163:
9289                     ; 2247     TIM1->CCER1 |=  TIM1_CCER1_CC1E;
9291  1535 7210525c      	bset	21084,#0
9292                     ; 2248 }
9295  1539 5b03          	addw	sp,#3
9296  153b 81            	ret
9348                     ; 2266 static void TI2_Config(uint8_t TIM1_ICPolarity,
9348                     ; 2267                        uint8_t TIM1_ICSelection,
9348                     ; 2268                        uint8_t TIM1_ICFilter)
9348                     ; 2269 {
9349                     	switch	.text
...
9357                     ; 2271     TIM1->CCER1 &=  (uint8_t)(~TIM1_CCER1_CC2E);
9359  153e 7219525c      	bres	21084,#4
9360                     ; 2274     TIM1->CCMR2  = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF ))) 
9360                     ; 2275                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
9373                     ; 2277     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
9375  1557 0d02          	tnz	(OFST+1,sp)
9376  1559 2706          	jreq	L5463
9377                     ; 2279         TIM1->CCER1 |= TIM1_CCER1_CC2P;
9379  155b 721a525c      	bset	21084,#5
9381  155f 2004          	jra	L7463
9382  1561               L5463:
9383                     ; 2283         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
9385  1561 721b525c      	bres	21084,#5
9386  1565               L7463:
9387                     ; 2286     TIM1->CCER1 |=  TIM1_CCER1_CC2E;
9389  1565 7218525c      	bset	21084,#4
9390                     ; 2287 }
9393  1569 5b03          	addw	sp,#3
9394  156b 81            	ret
9446                     ; 2305 static void TI3_Config(uint8_t TIM1_ICPolarity,
9446                     ; 2306                        uint8_t TIM1_ICSelection,
9446                     ; 2307                        uint8_t TIM1_ICFilter)
9446                     ; 2308 {
9447                     	switch	.text
...
9455                     ; 2310     TIM1->CCER2 &=  (uint8_t)(~TIM1_CCER2_CC3E);
9457  156e 7211525d      	bres	21085,#0
9458                     ; 2313     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF))) 
9458                     ; 2314                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
9471                     ; 2317     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
9473  1587 0d02          	tnz	(OFST+1,sp)
9474  1589 2706          	jreq	L7763
9475                     ; 2319         TIM1->CCER2 |= TIM1_CCER2_CC3P;
9477  158b 7212525d      	bset	21085,#1
9479  158f 2004          	jra	L1073
9480  1591               L7763:
9481                     ; 2323         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3P);
9483  1591 7213525d      	bres	21085,#1
9484  1595               L1073:
9485                     ; 2326     TIM1->CCER2 |=  TIM1_CCER2_CC3E;
9487  1595 7210525d      	bset	21085,#0
9488                     ; 2327 }
9491  1599 5b03          	addw	sp,#3
9492  159b 81            	ret
9544                     ; 2346 static void TI4_Config(uint8_t TIM1_ICPolarity,
9544                     ; 2347                        uint8_t TIM1_ICSelection,
9544                     ; 2348                        uint8_t TIM1_ICFilter)
9544                     ; 2349 {
9545                     	switch	.text
...
9553                     ; 2352     TIM1->CCER2 &=  (uint8_t)(~TIM1_CCER2_CC4E);
9555  159e 7219525d      	bres	21085,#4
9556                     ; 2355     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF )))
9556                     ; 2356                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
9569                     ; 2359     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
9571  15b7 0d02          	tnz	(OFST+1,sp)
9572  15b9 2706          	jreq	L1373
9573                     ; 2361         TIM1->CCER2 |= TIM1_CCER2_CC4P;
9575  15bb 721a525d      	bset	21085,#5
9577  15bf 2004          	jra	L3373
9578  15c1               L1373:
9579                     ; 2365         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4P);
9581  15c1 721b525d      	bres	21085,#5
9582  15c5               L3373:
9583                     ; 2369     TIM1->CCER2 |=  TIM1_CCER2_CC4E;
...
9679  0000               L101:
9680  0000 2e2e5c6c6962  	dc.b	"..\lib\src\stm8s_t"
9681  0012 696d312e6300  	dc.b	"im1.c",0
9701                     	end
