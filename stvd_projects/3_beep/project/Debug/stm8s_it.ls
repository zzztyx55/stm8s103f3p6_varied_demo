 ...
 525                     ; 330  }
 528  000f 80            	iret
 551                     ; 337  INTERRUPT_HANDLER(UART1_RX_IRQHandler, 18)
 551                     ; 338  {
 552                     	switch	.text
 553  0010               f_UART1_RX_IRQHandler:
 557                     ; 342  }
 560  0010 80            	iret
 582                     ; 350 INTERRUPT_HANDLER(I2C_IRQHandler, 19)
 582                     ; 351 {
 583                     	switch	.text
 584  0011               f_I2C_IRQHandler:
 588                     ; 355 }
 591  0011 80            	iret
 613                     ; 429  INTERRUPT_HANDLER(ADC1_IRQHandler, 22)
 613                     ; 430  {
 614                     	switch	.text
 615  0012               f_ADC1_IRQHandler:
 619                     ; 434  }
 622  0012 80            	iret
 645                     ; 455  INTERRUPT_HANDLER(TIM4_UPD_OVF_IRQHandler, 23)
 645                     ; 456  {
 646                     	switch	.text
 647  0013               f_TIM4_UPD_OVF_IRQHandler:
 651                     ; 461  }
 654  0013 80            	iret
 677                     ; 469 INTERRUPT_HANDLER(EEPROM_EEC_IRQHandler, 24)
 677                     ; 470 {
 678                     	switch	.text
